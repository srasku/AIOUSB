                                                   ...
                                                   )
{
    ...
    num_scans = MIN( (int)num_scans, (int)(tmpbuffer_size / AIOContinuousBufNumberChannels(buf))*AIOContinuousBufNumberChannels(buf) );

    retval += buf->fifo->PopN( buf->fifo, read_buf, num_scans );
