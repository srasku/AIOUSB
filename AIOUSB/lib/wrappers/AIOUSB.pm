...
*AIOUSB_getDevice = *AIOUSBc::AIOUSB_getDevice;
...
*AIOUSB_INIT_PATTERN = *AIOUSBc::AIOUSB_INIT_PATTERN;
*aiousbInit = *AIOUSBc::aiousbInit;
...
*DACRange_begin = *AIOUSBc::DACRange_begin;
...
*DACRange_end = *AIOUSBc::DACRange_end;
*FIFO_Method_begin = *AIOUSBc::FIFO_Method_begin;
...
*FIFO_Method_end = *AIOUSBc::FIFO_Method_end;
*ResultCode_begin = *AIOUSBc::ResultCode_begin;
...
*AIOUSB_ERROR_DEVICE_NOT_FOUND = *AIOUSBc::AIOUSB_ERROR_DEVICE_NOT_FOUND;
*AIOUSB_ERROR_LIBUSB = *AIOUSBc::AIOUSB_ERROR_LIBUSB;
*ResultCode_end = *AIOUSBc::ResultCode_end;
*AIOUSB_ERROR_OFFSET = *AIOUSBc::AIOUSB_ERROR_OFFSET;
*ADRegister_begin = *AIOUSBc::ADRegister_begin;
...
*AD_REGISTER_MUX_START_END = *AIOUSBc::AD_REGISTER_MUX_START_END;
*ADRegister_end = *AIOUSBc::ADRegister_end;
...
*ADGainCode_begin = *AIOUSBc::ADGainCode_begin;
...
*ADGainCode_end = *AIOUSBc::ADGainCode_end;
