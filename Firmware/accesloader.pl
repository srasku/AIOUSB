...
#		when( "001d" ) { $hexFile = "USB-IDIO-16.hex" }			# USB-II-8
		...
		when( "0040" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-16A
		when( "0041" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-16E
		when( "0042" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-16A
		when( "0043" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-16
		when( "0044" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-16E
		when( "0045" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-64MA
		when( "0046" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-64ME
		when( "0047" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-64MA
		when( "0048" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-64M
		when( "0049" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-64ME
		when( "004a" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-32A
		when( "004b" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-32E
		when( "004c" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-32A
		when( "004d" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-32
		when( "004e" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-32E
		when( "004f" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-64A
		when( "0050" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-64E
		when( "0051" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-64A
		when( "0052" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-64
		when( "0053" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-64E
		when( "0054" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-96A
		when( "0055" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-96E
		when( "0056" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-96A
		when( "0057" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-96
		when( "0058" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-96E
		when( "0059" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-128A
		when( "005a" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI16-128E
		when( "005b" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-128A
		when( "005c" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-128
		when( "005d" ) { $hexFile = "USB-AI16-16.hex" }			# USB-AI12-128E
		when( "0140" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-16A
		when( "0141" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-16E
		when( "0142" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-16A
		when( "0143" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-16
		when( "0144" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-16E
		when( "0145" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-64MA
		when( "0146" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-64ME
		when( "0147" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-64MA
		when( "0148" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-64M
		when( "0149" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-64ME
		when( "014a" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-32A
		when( "014b" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-32E
		when( "014c" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-32A
		when( "014d" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-32
		when( "014e" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-32E
		when( "014f" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-64A
		when( "0150" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-64E
		when( "0151" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-64A
		when( "0152" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-64
		when( "0153" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-64E
		when( "0154" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-96A
		when( "0155" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-96E
		when( "0156" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-96A
		when( "0157" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-96
		when( "0158" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-96E
		when( "0159" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-128A
		when( "015a" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO16-128E
		when( "015b" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-128A
		when( "015c" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-128
		when( "015d" ) { $hexFile = "USB-AIO16-16.hex" }			# USB-AIO12-128E
...
#		when( "8031" ) { $hexFile = "USB-IIRO4-COM.hex" }		# USB-IIRO4-COM (Xerox)
	...
	$pauseForRenum = 1;
	$command = "fxload -t fx2 -D " . $deviceDir . $parameters[ 1 ] . "/" . $parameters[ 3 ] . " -I " . $firmwareDir . $hexFile;
	print $command . "\n";
	system( $command );
}	# foreach $currentLine( ...
